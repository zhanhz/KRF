...
def knn(ref, query, k, eu_dist=True):
    d, i = _knn.knn(ref, query, k, eu_dist)
    i -= 1
    return d, i
...
class KNN(nn.Module):
    ...
    def __init__(self, k, transpose_mode=False, eu_dist = True):
    ...
    def forward(self, ref, query):
        ...
        with torch.no_grad():
            ...
            for bi in range(batch_size):
                ...
                d, i = knn(r.float(), q.float(), self.k, self.eu_dist)
