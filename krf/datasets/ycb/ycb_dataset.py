...
class Dataset():
    ...
    def __init__(self, dataset_name, DEBUG=False):
        ...
        if dataset_name == 'train':
            ...
            # self.path = '/home/zhanhz/FFB6D/ffb6d/datasets/ycb/YCB_Video_Dataset/all_data.txt'
            ...
            # self.path = '/home/zhanhz/FFB6D/ffb6d/datasets/ycb/YCB_Video_Dataset/all_real.txt'
            self.all_lst = bs_utils.read_lines(self.path)
    ...
    def get_item(self, item_name):
        ...
        dpt_xyz, rgb_pts_all, all_choose = self.dpt_2_pcld(dpt_m, rgb, 1.0, K)
        all_cld = dpt_xyz.reshape(-1,3)
